...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = 0x69AAC8142e38d99C547A65Bf6A4CB0082ED53Fd1;
...
contract NIOBOT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "NIOBOT";
    ...
    uint256 internal _tokenTotal = 300_000_000_000_000e9;
    ...
    uint256 public markdevFee=400;
    
    
    address markdevAddress=0x044fE3203ce75628ABE053e34397BA5D944f4b45;
    ...
    uint256 roundValue = value.ceil(markdevFee);
    uint256 onePercent = roundValue.mul(markdevFee).div(10000);
    return onePercent;
  }
    ...
    function _transfer(
        ...
        _reflectionBalance[markdevAddress] = _reflectionBalance[markdevAddress].add(tokensToBurn.mul(rate));
        ...
        emit Transfer(sender, markdevAddress, tokensToBurn);
    }
    ...
    function setmarkdevFee(uint256 amount) external onlyOwner {
        markdevFee= amount;
    }
